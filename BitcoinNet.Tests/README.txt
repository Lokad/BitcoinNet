...
Here are the trait BitcoinNet is using :
...
"Benchmark" are simple method you can use or modify to measure performance of BitcoinNet, they have some file system dependencies.
