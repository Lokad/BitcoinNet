namespace BitcoinNet.Tests
{
	...
	{
		public static BitcoinCashNodeDownloadData BitcoinCash { get; set; } = new BitcoinCashNodeDownloadData();

		public class BitcoinCashNodeDownloadData
		{
			public readonly NodeDownloadData v0_18_2 = new NodeDownloadData
			{
				Version = "0.18.2",
