namespace BitcoinNet.Protocol
{
	public class ProtocolCapabilities
	{
		...
		/// </summary>
		public bool PeerTooOld { get; set; }

		/// <summary>
		///     nTime field added to CAddress, starting with this version;
		///     if possible, avoid requesting addresses nodes older than this
		/// </summary>
		public bool SupportTimeAddress { get; set; }

		public bool SupportGetBlock { get; set; }

		/// <summary>
		///     BIP 0031, pong message, is enabled for all versions AFTER this one
		/// </summary>
		public bool SupportPingPong { get; set; }

		/// <summary>
		///     "mempool" command, enhanced "getdata" behavior starts with this version
		/// </summary>
		public bool SupportMempoolQuery { get; set; }

		/// <summary>
		///     "reject" command
		/// </summary>
		public bool SupportReject { get; set; }

		/// <summary>
		///     ! "filter*" commands are disabled without NODE_BLOOM after and including this version
		/// </summary>
		public bool SupportNodeBloom { get; set; }

		/// <summary>
		///     ! "sendheaders" command and announcing blocks with headers starts with this version
		/// </summary>
		public bool SupportSendHeaders { get; set; }

		/// <summary>
		///     ! Version after which witness support potentially exists
		/// </summary>
		public bool SupportWitness { get; set; }

		/// <summary>
		///     short-id-based block download starts with this version
		/// </summary>
		public bool SupportCompactBlocks { get; set; }

		/// <summary>
		///     Support checksum at p2p message level
		/// </summary>
		public bool SupportCheckSum { get; set; }

		public bool SupportUserAgent { get; set; }
