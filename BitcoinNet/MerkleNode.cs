...
namespace BitcoinNet
{
	public class MerkleNode
	{
		...
		public static MerkleNode GetRoot(int leafCount)
		{
			if (leafCount > 1024 * 1024)
			{
				throw new ArgumentOutOfRangeException(nameof(leafCount),
					"To prevent DDOS attacks, BitcoinNet does not support more than 1024*1024 transactions for the creation of a MerkleNode, if this case is legitimate, contact us.");
			}
		...
		public void UpdateHash()
		{
			...
			{
				Hash = Hashes.Hash256(Left.Hash.ToBytes().Concat(right.Hash.ToBytes()).ToArray());
			}
		}
