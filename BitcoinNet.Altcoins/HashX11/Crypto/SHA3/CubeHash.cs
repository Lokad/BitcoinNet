...
namespace BitcoinNet.Altcoins.HashX11.Crypto.SHA3
{
    ...
    internal abstract class CubeHash : BlockHash, ICryptoNotBuildIn
    {
        ...
        static CubeHash()
        {
            ...
            {
                CubeHash ch = (CubeHash)HashFactory.Crypto.SHA3.CreateCubeHash(BitcoinNet.Altcoins.HashX11.HashSize.HashSize256);
        ...
        public CubeHash(BitcoinNet.Altcoins.HashX11.HashSize a_hash_size)
